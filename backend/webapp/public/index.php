...
$app->delete('/evenements/{id}/comment[/]', EventController::class.':deleteComment')->setName('supprimerCommentaire')->add(Cors::class.':checkHeaderOrigin')->add(Cors::class.':headersCORS');
