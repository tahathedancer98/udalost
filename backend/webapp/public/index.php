...
$app->delete('/evenements/{id}/commentaire[/]', EventController::class.':deleteComment')->setName('supprimerCommentaire')->add(Cors::class.':checkHeaderOrigin')->add(Cors::class.':headersCORS');
